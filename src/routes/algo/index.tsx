            ...
            <article className="flex flex-col gap-6 text-sm leading-loose">
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <ul className="flex list-disc flex-col gap-1 pl-5">
                        <li>
                            便當（第 1 項，價格 <Tex>{`p_1`}</Tex>、數量{" "}
                            <Tex>{`q_1`}</Tex>）：價格 <code>90 ~ 150</code>，且以{" "}
                            <code>0</code>、<code>5</code>、<code>9</code>{" "}
                            結尾，例如 99、120、135。
                        </li>
                        <li>
                            飲料（第 2 項，價格 <Tex>{`p_2`}</Tex>、數量{" "}
                            <Tex>{`q_2`}</Tex>）：價格 <code>40 ~ 90</code>，且以{" "}
                            <code>0</code>、<code>5</code> 結尾，例如 45、60、85。
                        </li>
                        <li>
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <p>
                        ...
                        <Tex>i</Tex> 求一組價格 <Tex>{`p_i`}</Tex> 與數量{" "}
                        <Tex>{`q_i`}</Tex>，另加塑膠袋數量 <Tex>{`q_*`}</Tex>
                        （單價 <Tex>{`p_* = 1`}</Tex>），滿足：
                    </p>
                    <Formula>
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <ol className="flex list-decimal flex-col gap-1 pl-5">
                        ...
                        <li>
                            各品項數量 <Tex>{`q_i`}</Tex> 須盡量平衡，避免如 20
                            個便當配 4 個飲料的失衡組合。
                        </li>
                        <li>塑膠袋為選配，可有可無（<Tex>{`q_* \\ge 0`}</Tex>）。</li>
                        <li>
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <ol className="flex list-decimal flex-col gap-2 pl-5">
                        <li>為每個品項 <Tex>i</Tex> 列出其合法價格集合 <Tex>{`P_i`}</Tex>。</li>
                        <li>
                            以深度優先（DFS）逐項決定：第 <Tex>i</Tex> 項可「不選」（
                            <Tex>{`q_i = 0`}</Tex>）或挑某價格 <Tex>{`p_i`}</Tex>{" "}
                            搭配正數量 <Tex>{`q_i`}</Tex>，並扣去 <Tex>{`p_i \\cdot q_i`}</Tex>。
                        </li>
                        <li>
                            所有品項決定後，剩餘金額即為塑膠袋數量 <Tex>{`q_*`}</Tex>；
                            若落在 <Tex>{`0 \\le q_* \\le 4`}</Tex> 且符合所有約束，
                            記為一個候選解，並計算平衡分數{" "}
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <p className="text-muted-foreground">
                        品項數 <Tex>n</Tex> 視為小常數（一般為 2）；固定 <Tex>n</Tex>
                        後即為下方所述的多項式級數。
                    </p>
                    <p>
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <ul className="flex list-disc flex-col gap-1 pl-5">
                        <li>
                            ...
                            <Tex>{`q_i`}</Tex>（其鬆弛解 <Tex>{`q_i^*`}</Tex>）
                            分支成 <Tex>{String.raw`q_i \le \lfloor q_i^* \rfloor`}</Tex> 與{" "}
                    ...
                    <p>
                        本實作<strong>刻意不採用</strong>這兩種方法，而用全枚舉
                        （exhaustive search），原因有三：
                    </p>
                    <ol className="flex list-decimal flex-col gap-1 pl-5">
                        <li>
